...
- Keeping your device PIN, password, fingerprint, or face unlock credentials secure
...
- The Application is for personal health tracking only
- You should always seek the advice of qualified healthcare providers with any questions regarding medical conditions
- You should never disregard professional medical advice or delay in seeking it because of information recorded in the Application
...
- Collect your personal health information
- Transmit your data to any servers
- Have access to your data
- Store your data in the cloud (unless you explicitly choose to save backups to your personal cloud storage)
...
- **Free Trial:** 7-day free trial period for new users
...
- **Security from viruses or other harmful components**
...
### 6.2 User Responsibility for PHI
You are responsible for:
- Deciding what personal health information (PHI) to enter into the Application
- Maintaining the confidentiality of your PHI
- Complying with any laws applicable to your handling of PHI
- Obtaining any necessary consents before sharing exported data with third parties

### 6.3 No Medical Records
...
- Upon posting the updated Agreement in the Application
- When you continue to use the Application after such changes
...
- Discontinue support for older device operating systems
- Change subscription pricing (with advance notice)
- Modify functionality or user interface
...
- You violate any applicable laws while using the Application
- Your use of the Application creates legal liability for us
- We decide to discontinue the Application

### 8.3 Effect of Termination
Upon termination:
- Your license to use the Application immediately ends
- You must immediately cease all use and uninstall the Application
- All data stored locally on your device will be deleted when you uninstall
- Subscription fees are non-refundable (except as required by law)
- Sections that by their nature should survive termination will survive (including warranties disclaimers, limitation of liability, and dispute resolution provisions)
...
- Such Feedback is entirely voluntary
- We may use Feedback without any obligation to you
- You grant us a perpetual, irrevocable, royalty-free, worldwide license to use, modify, and incorporate Feedback into the Application
...
- Subject to any restrictions that would prohibit you from using the Application
...
- Any health decisions made based on information recorded in the Application
...
- Arbitration shall be governed by the rules of [Arbitration Organization]
- The arbitration shall take place in [Location/Virtual]
- Each party shall bear their own costs and attorneys' fees
- The arbitrator's decision shall be final and binding
- Judgment on the arbitration award may be entered in any court having jurisdiction

**Class Action Waiver:**
**YOU AGREE THAT DISPUTES WILL BE RESOLVED INDIVIDUALLY, NOT AS PART OF A CLASS ACTION OR COLLECTIVE ACTION. YOU WAIVE ANY RIGHT TO PARTICIPATE IN A CLASS ACTION LAWSUIT OR CLASS-WIDE ARBITRATION.**

### 12.4 Exceptions to Arbitration
Either party may seek injunctive or other equitable relief in court to:
- Enforce intellectual property rights
- Stop unauthorized use or misuse of the Application
...
3. **You understand this is a legally binding agreement**
4. **You are at least 13 years of age (or have parental consent if under 18)**
5. **You understand the Application is not a medical device and does not provide medical advice**
6. **You are responsible for creating backups of your data**
7. **You understand we have no liability for data loss**
8. **You accept the limitations of liability and disclaimer of warranties**
9. **You agree to the arbitration and class action waiver provisions**
